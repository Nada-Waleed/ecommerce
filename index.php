...
<div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active" data-bs-interval="10000">
      <img src="img/header/home3-banner.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block ">
      <h2 class="black-friday">Black Friday</h2>      </div>
    </div>
    <div class="carousel-item" data-bs-interval="2000">
      <img src="img/header/home2-default-banner2.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
      <h2 class="black-friday">Black Friday</h2>      </div>
    </div>
    <div class="carousel-item">
      <img src="img/header/blog-post-6.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
      <h2 class="black-friday" >Black Friday</h2>
      </div>
    </div>
  </div>
...
<!-- kids men women -->
<div class="kids-men-women pt-5 pb-5">
    <div class="container pt-5 pb-5">
        <div class="row">
            
            <div class="col-lg-4 col-md-12 coll">
            <img src="img/banner-1.jpg" class="img-fluid img1">
            <div class="out-cat">
                <a class="inner-text btn btn btn-outline-light" href="">
                <h4 style="font-weight:bold ;" >Men’s</h4>
                </a>
            </div>
                
            </div>
            <div class="col-lg-4 col-md-12 coll">
            <img src="img/banner-2.jpg" class="img-fluid img1">
            <div class="out-cat">
                <a class="inner-text btn btn btn-outline-light" href="">
                <h4 style="font-weight:bold ;">Women’s</h4>
                </a>
            </div>
            </div>
            <div class="col-lg-4 col-md-12 coll">
            <img src="img/banner-3.jpg" class="img-fluid img1">
            <div class="out-cat">
                <a class="inner-text btn btn btn-outline-light" href="">
                  <h4 style="font-weight:bold ;">Kid’s</h4>
                </a>
            </div>
            </div>
        </div>
...
<div class="men pb-5">
    <div class="container pb-5">
        ...
        <div class="col-lg-4 col-md-12">
            <img src="img/man-large.jpg" class="img-fluid">
        </div>
...
<!-- Deal Of The Week -->
<div class="pb-5 deal pb-5">
  <div class="deal-col">
  <img src="img/mm.jpg" class="deal-img2 img-fluid  ">
  <div class="deal-h">
      <div class="container pt-5" >
        <div class="pt-5 deal-s" >
          <h2 style="color: #ffc107; font-weight:bolder;font-size:50px;" class="pt-5">Deal Of The Week</h2>
          <p class="text-black-50" style=" font-weight:800;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed
            do</br> ipsum dolor sit amet, consectetur adipisicing elit</p>
          <p class="text-black-50"><span style="color: #ffc107; font-weight:800;font-size:20px;">$35.00</span>/<small>HanBag</small> </p>
...
<div class="col-lg-4 col-md-12">
            <img src="img/women-large.jpg" class="img-fluid">
        </div>
</div>
</div>
</div>
